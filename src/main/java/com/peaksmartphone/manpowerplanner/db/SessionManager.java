package com.peaksmartphone.manpowerplanner.db;
...
public class SessionManager
{
      ...
      String pDBDialect)
  {
    ...
    LOG.debug("createSession: laden der Hibernate Factory");
    mConfiguration = new Configuration().configure(
        "com/peaksolution/prp/core/db/hibernate/hibernate.cfg.xml")
    ...
    LOG.debug("createSession: laden der Hibernate Factory erfolgreich.");
